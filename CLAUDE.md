...
- New API routes require updating `source/lambdas/api/authorizer/src/authorization-map.ts` (role permissions) and potentially `authorization.ts` (new path-parameter extractor) if the URL shape is novel
